...
export default function parseYoutubeIframe(html, playOnPopup) {
  let htmlParse
  let iframeList = []
  ...
  if (iframes && iframes.length) {
    ...
    Array.from(iframes).forEach((iframe, index) => {
      ...
      if (playOnPopup) {
        ...
        </svg></span></span><img src=https://i.ytimg.com/vi_webp/${idYoutube}/sddefault.webp alt='${title}'></div>`
