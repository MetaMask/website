...
const renderOptionsParse = ({fontWeightManual}) => ({
  ...
  renderNode: {
    ...
    [BLOCKS.HEADING_1]: (_, children) => ( <H1 fontWeightManual={fontWeightManual}> {children} </H1> ),
    [BLOCKS.HEADING_2]: (_, children) => ( <H2 fontWeightManual={fontWeightManual}> {children} </H2> ),
    [BLOCKS.HEADING_3]: (_, children) => ( <H3 fontWeightManual={fontWeightManual}> {children} </H3> ),
    [BLOCKS.HEADING_4]: (_, children) => ( <H4 fontWeightManual={fontWeightManual}> {children} </H4> ),
    [BLOCKS.HEADING_5]: (_, children) => ( <H5 fontWeightManual={fontWeightManual}> {children} </H5>),
...
const Bold = styled.span`font-weight: ${({theme}) => theme.font.weight.bold};`;
...
const H1 = styled.h1`
  ...
  font-weight: ${({fontWeightManual, theme}) => !fontWeightManual ? theme.font.weight.bold : 400};
...
const H3 = styled.h3`
  ...
  font-weight: ${({fontWeightManual, theme}) => !fontWeightManual ? theme.font.weight.semiBold : 400};
  @media (max-width: ${({theme}) => theme.device.mobile}) {
    font-size: 1.75rem;
  }
  /* work for font-weight manual, admin will control fw of H tag */
